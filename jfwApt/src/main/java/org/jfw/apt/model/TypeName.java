		...
		return mirror.accept(new SimpleTypeVisitor7<TypeName, Void>() {
			...
			public TypeName visitTypeVariable(javax.lang.model.type.TypeVariable t, Void p) {
				throw new UnsupportedOperationException(
						"javax.lang.model.type.TypeVariable convert org.jfw.apt.model.core.TypeName");
			}
	...
	public static TypeName get(Type type) {
		if (type instanceof Class<?>) {
			...
			if (classType.isArray())
				return ArrayTypeName.of(get(classType.getComponentType()));
			...
			throw new UnsupportedOperationException(
					"java.lang.reflect.TypeVariable convert org.jfw.apt.model.core.TypeName");

...
public class CronContext {
	...
	public CronContext(String expression, TimeZone timeZone) {
	...
	private void parse(String expression) throws IllegalArgumentException {
		ArrayList<String> fields = this.split(expression);
		if (fields.size() != 6) 
			throw new IllegalArgumentException(String.format(""
					+ "cron expression must consist of 6 fields (found %d in %s)", fields.size(), expression));
		
		setNumberHits(this.seconds, fields.get(0), 0, 60);
		setNumberHits(this.minutes, fields.get(1), 0, 60);
		setNumberHits(this.hours, fields.get(2), 0, 24);
		setDaysOfMonth(this.daysOfMonth, fields.get(3));
		setMonths(this.months, fields.get(4));
		setDays(this.daysOfWeek, replaceOrdinals(fields.get(5), "SUN,MON,TUE,WED,THU,FRI,SAT"), 8);
	...
	public static void main(String[] args){
		for(String a:"1-2-445t4-6".split("-"))
		{
